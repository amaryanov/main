...
static char *ngx_http_magaz(ngx_conf_t *cf, ngx_command_t *cmd, void *conf);
static ngx_int_t ngx_http_magaz_variable(ngx_http_request_t *r, ngx_http_variable_value_t *v, uintptr_t data);

static ngx_command_t  ngx_http_magaz_commands[] = {
...
static ngx_http_module_t  ngx_http_magaz_module_ctx = {
    NULL,  NULL, NULL, NULL,  NULL, NULL, NULL, NULL 
};

ngx_module_t  ngx_http_magaz_module = {
    NGX_MODULE_V1,
    &ngx_http_magaz_module_ctx,       /* module context */
    ngx_http_magaz_commands,          /* module directives */
...
static char * ngx_http_magaz(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
  ...
  var->get_handler = ngx_http_magaz_variable;
